...
const NativePayments: {
  ...
  supportedGateways: IS_ANDROID
    ? ['stripe', 'braintree', 'worldpay'] // On Android, Payment Gateways are supported out of the gate.
  ...
  canMakePayments(methodData: object) {
    return new Promise((resolve, reject) => {
      ...
      // Check to see if Apple Pay Support for adding cards within the journey is active. On iOS 11 it is available but it doesn't seem to work on iOS 10.
